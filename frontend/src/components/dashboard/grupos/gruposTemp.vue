<template>
    ...
    <div class="containerSmall">
        ...
        <div class="itens" v-if="isMobile">
            <gruposFiltros :showPopup="showPopupFiltros" @close="closePopupFiltros" :currentFilters="filters"
                @apply-filters="handleFiltersApplied" @clear-filters="handleFiltersCleared" />
            <gruposData :filters="filters" />
        </div>
        <div class="itens" v-else>
            <gruposFiltros :showPopup="true" :currentFilters="filters" @apply-filters="handleFiltersApplied"
...
import gruposData from './components/gruposData.vue'
import gruposFiltros from './components/gruposFiltros.vue';
import { ref } from 'vue';
