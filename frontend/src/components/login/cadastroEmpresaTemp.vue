    ...
    <div class="main-login">
        ...
        <div class="container">
            <div class="form-image">
                <img src="../../assets/images/empresario.jpg" alt="">
            </div>
            <div class="form">
                <form @submit="handleSubmit">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-box">
                            ...
                            <input id="lastname" type="text" v-model="cnpj" name="cnpj" maxlength="18"
                                @input="mascaraCNPJInput" @paste="colarCNPJInput" placeholder="00.000.000/0000-00"
                                required>
                        </div>
                        <div class="input-box">
...
import { ref } from 'vue';
import { fieldCollector, resetFieldBorders, removeField, verificaCEP, MascaraCNPJ, colarCNPJ, colarCEP, MascaraCEP, MascaraCelular, colarCelular, validarCnpj, RemoveMascaraCNPJ, RemoveMascaraCEP, RemoveMascaraContato } from '@/utils/utils.js'
export default {
    components: {
        Mensagem,
    ...
    methods: {
        ...
        async cadastarEmpresa() {
            ...
            if (this.cnpj) {
                cnpj = RemoveMascaraCNPJ(this.cnpj)
            }
