<template>
    <div class="popup-container" @click="closePopupOnOverlay" v-if="showEditarGruposPopup">
        <div class="popup-content">
            ...
            <div class="form-container">
                <div class="form-group">
                    ...
                    <select id="plano" class="form-control" disabled v-model="idPlanos" required>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="dataInicio" disabled v-model="dataInicio" required>
                </div>
                <div class="form-group">
                    <label for="dataFinal">Data de finalização</label>
                    <input type="date" class="form-control" id="dataFinal" v-model="dataFinal" required>
                </div>
                <div class="form-group">
...
export default {
    ...
    methods: {
        ...
        carregarDados() {
            if (this.data) {
                this.maxHorarios = this.data.planos.maxSessoes;
                this.dataFinal = this.data.dataFinal ? this.formatDateForInput(this.data.dataFinal) : '';
                this.dataInicio = this.data.dataInicio ? this.formatDateForInput(this.data.dataInicio) : '';
                this.idPlanos = this.data.idPlanos;
                this.horarios = this.data.datas;
        ...
        atualizarPlano() {
            ...
            axios.put(`${store.state.apiUrl}/grupos/${this.data.idGrupo}`, data, {
