        ...
        <div class="popup-content">
            ...
            <div class="form-container">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" @keyup.enter="editarUsuario" id="nome" v-model="nome"
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="text" name="email" @keyup.enter="editarUsuario" v-model="email" required>
                </div>
                <div class="form-group">
                    <label for="senha">Senha (Opcional)</label>
                    <input id="senha" type="password" v-model="senha" @keyup.enter="editarUsuario" name="senha"
                        required>
                </div>
            </div>
            <div class="buttons">
...
export default {
    ...
    props: {
        data: Object,
        showEditarUsuariosPopup: Boolean
    },
    components: {
        Mensagem,
