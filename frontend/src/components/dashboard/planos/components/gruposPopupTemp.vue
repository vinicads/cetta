<template>
    <div class="modal-overlay">
        <div class="modal-content">
            <button class="close-button" @click="fecharPopup">&times;</button>
            <div class="containerData">
                <popupCarregamentoTemp v-if="loading" />
                <div class="title">Grupos disponíveis </div>
                    ...
                    <div v-for="grupo in grupos" :key="grupo.idGrupo" style="padding: 1rem; border-radius: 8px;"
                        ...
                        <div class="mt-2 space-y-3">
                            <div v-for="(data, index) in grupo.datas" :key="index"
                                ...
                                <span class="font-medium text-md" style="font-weight: 400;">{{
                                    formatarDiaSemana(data.dia) }} -
                                    {{ data.hora }}</span>
                            </div>
                        ...
                        <div class="mt-9 flex justify-between items-center bottom"
                            ...
                            <div class="buttons">
                                <button @click="selecionarGrupo(grupo.idGrupo)">
                                    Selecionar
                                </button>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        selecionarGrupo(idGrupo) {
            this.$emit('grupo-selecionado', idGrupo);
            this.fecharPopup();
        },
