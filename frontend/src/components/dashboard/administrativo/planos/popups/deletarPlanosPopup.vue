<template>
    ...
    <Mensagem :mensagem="mensagemAlerta" v-if="!mensagemErro && !mensagemSucesso" tipo="Alerta"
      @fechar-modal="fecharModal" />
    <div class="modal-overlayy" @click="closePopupOnOverlay" v-if="showDeletePlanosPopup">
      <div class="modal-contentt">
        ...
        <div class="avisoModall">
          <div class="botaoFecharApagar"><button @click="deletarPlano">Apagar</button></div>
  ...
  export default {
    ...
    methods: {
      ...
      deletarPlano() {
        ...
        this.mensagemErro = '';
        this.mensagemSucesso = '';
        axios.delete(`${store.state.apiUrl}/planos/${this.idPlanos}`,
          {
