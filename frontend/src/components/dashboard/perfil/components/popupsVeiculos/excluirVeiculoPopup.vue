<template>
    ...
    <Mensagem :mensagem="mensagemAlerta" v-if="!mensagemErro && !mensagemSucesso" tipo="Alerta"
      @fechar-modal="fecharModal" />
    <div class="modal-overlayy" @click="closePopupOnOverlay" v-if="showDeleteVeiculoPopup">
      <div class="modal-contentt">
        ...
        <div class="avisoModall">
          <div class="botaoFecharApagar"><button @click="deletarVeiculo">Apagar</button></div>
  ...
  export default {
    ...
    props: {
      data: Object,
      showDeleteVeiculoPopup: Boolean
    },
    components: {
      Mensagem,
    ...
    methods: {
      ...
      deletarVeiculo() {
        ...
        this.mensagemErro = '';
        this.mensagemSucesso = '';
        axios.delete(`${store.state.apiUrl}/veiculos/${this.idVeiculo}`,
          {
    ...
    mounted() {
      ...
      this.idVeiculo = this.data.idVeiculo;
    },
    beforeUnmount() {
