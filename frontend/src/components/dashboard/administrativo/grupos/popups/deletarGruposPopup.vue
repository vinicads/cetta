<template>
    ...
    <Mensagem :mensagem="mensagemAlerta" v-if="!mensagemErro && !mensagemSucesso" tipo="Alerta"
      @fechar-modal="fecharModal" />
    <div class="modal-overlayy" @click="closePopupOnOverlay" v-if="showDeleteGruposPopup">
      <div class="modal-contentt">
        ...
        <div class="avisoModall">
          <div class="botaoFecharApagar"><button @click="deletarGrupo">Apagar</button></div>
  ...
  export default {
    ...
    methods: {
      ...
      deletarGrupo() {
        ...
        this.mensagemErro = '';
        this.mensagemSucesso = '';
        axios.delete(`${store.state.apiUrl}/grupos/${this.idGrupo}`,
          {
