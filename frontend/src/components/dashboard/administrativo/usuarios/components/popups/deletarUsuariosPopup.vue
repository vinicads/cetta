<template>
    ...
    <Mensagem :mensagem="mensagemAlerta" v-if="!mensagemErro && !mensagemSucesso" tipo="Alerta"
      @fechar-modal="fecharModal" />
    <div class="modal-overlayy" @click="closePopupOnOverlay" v-if="showDeleteUsuariosPopup">
      <div class="modal-contentt">
        ...
        <div class="avisoModall">
          <div class="botaoFecharApagar"><button @click="deletarUsuario">Apagar</button></div>
  ...
  export default {
    ...
    props: {
      data: Object,
      showDeleteUsuariosPopup: Boolean
    },
    components: {
      Mensagem,
    ...
    methods: {
      ...
      deletarUsuario() {
        ...
        this.mensagemErro = '';
        this.mensagemSucesso = '';
        axios.delete(`${store.state.apiUrl}/users/${this.idAutenticacao}`,
          {
    ...
    mounted() {
      ...
      this.idAutenticacao = this.data.idAutenticacao;
    },
    beforeUnmount() {
